...
public class RecentFragment extends Fragment {
    ...
    public void getVideo() {
        ...
        if (!TextUtils.isEmpty(VideoPlayerManager.getRecentPlay())) {
            final ArrayList<MediaData> arrayList = new Gson().fromJson(VideoPlayerManager.getRecentPlay(), new TypeToken<List<MediaData>>() {
    ...
    public void initAdapter(ArrayList<MediaData> arrayList, int i) {
        ...
        if (arrayList.size() > 0) {
            ...
            if (i == 0) {
                ...
                recentrecycler.setLayoutManager(new GridLayoutManager((Context) getActivity(), 3, RecyclerView.VERTICAL, false));
            }
